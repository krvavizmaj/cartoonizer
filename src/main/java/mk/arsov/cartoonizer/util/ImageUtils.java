...
public class ImageUtils {
   ...
   */
  public Point2D.Double[][] createCircularVectorField(int width, int height) {
   ...
   */
  public BufferedImage blur(BufferedImage sourceImage) {
   ...
   */
  protected double[] rgbToXYZ(double[] rgb) {
   ...
   */
  protected double[] xyzToLab(double[] xyz) {
