...
public class EdgeTangentFlow {
   ...
   */
  public Point2D.Double[][] calculate(Point2D.Double[][] tangentVectorField) {
...
//                  fi(normalizedTangentVectors[i][j], normalizedTangentVectors[y][x]) 
  ...
  /**
   * @return Returns the etfKernelRadius.
   */
  public int getEtfKernelRadius() {
    return etfKernelRadius;
  }

  
  /**
   * @param etfKernelRadius The etfKernelRadius to set.
   */
  public void setEtfKernelRadius(int etfKernelRadius) {
    this.etfKernelRadius = etfKernelRadius;
  }
